...
// =========================
const APPEAR_KEY = 'barber_appearance_v1';
...
function applyAppearance(){
  ...
  // app bg
  document.documentElement.style.setProperty('--app-bg-url', cssUrlOrNone(appearance.appBg));
  document.documentElement.style.setProperty('--app-bg-scale', String(appearance.appBgScale ?? 1));
  document.documentElement.style.setProperty('--app-bg-x', (appearance.appBgX ?? 0) + 'px');
  document.documentElement.style.setProperty('--app-bg-y', (appearance.appBgY ?? 0) + 'px');
...
function openBgEditor(target){
  ...
  if (isBtn){
    ...
    draft.y = appearance.appBgY ?? 0;
    draft.scale = appearance.appBgScale ?? 1;
  }
...
bgSaveBtn?.addEventListener('click', ()=>{
  ...
  if (bgTarget === 'btn'){
    ...
    appearance.appBgY = draft.y;
    appearance.appBgScale = draft.scale;
  }
...
clearAppBgBtn?.addEventListener('click', ()=>{
  ...
  appearance.appBgX = 0; appearance.appBgY = 0; appearance.appBgScale = 1;
  saveAppearance(appearance);
  applyAppearance();
  updateAppearanceThumbs();
});
